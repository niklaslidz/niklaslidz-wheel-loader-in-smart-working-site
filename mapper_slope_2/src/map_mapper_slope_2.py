...
from map_util_slope_2 import MapDrawer
...
class Mapper:
    ...
    def __init__(self):
        ...
        rospy.Subscriber('/ukf/odometry/filtered/1imu_1gps', Odometry, self.process_ukf)
    ...
    def shutdown(self):
        ...
        self.mapper.SaveMap('/home/hanke/catkin_ws/src/mapper_slope_2/solution_map_slope.jpg')
