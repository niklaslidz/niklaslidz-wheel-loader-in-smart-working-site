...
from map_util_slope_3 import MapDrawer
...
class Mapper:
    ...
    def __init__(self):
        ...
        rospy.Subscriber('/ekf/odometry/filtered/1imu_1gps', Odometry, self.process_ukf)
    ...
    def shutdown(self):
        ...
        self.mapper.SaveMap('/home/hanke/catkin_ws/src/mapper_slope_3/ekf_1imu1gps_slope.jpg')
